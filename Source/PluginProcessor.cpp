...
{
    return new GoldStarEchoChamberAudioProcessorEditor (*this);
}
...
// VU meter accessors
float GoldStarEchoChamberAudioProcessor::getInputLevel() const {
    return leftEngine ? leftEngine->getInputLevel() : 0.0f;
}
float GoldStarEchoChamberAudioProcessor::getProcessLevel() const {
    return leftEngine ? leftEngine->getProcessLevel() : 0.0f;
}
float GoldStarEchoChamberAudioProcessor::getOutputLevel() const {
    return leftEngine ? leftEngine->getOutputLevel() : 0.0f;
}
